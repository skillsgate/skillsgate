...
export default function PublisherSkillsPage() {
	...
	return (
		<div>
			...
			{/* Connected Repos — Coming Soon */}
			<section className="mt-10">
				<div className="flex items-center gap-3 mb-4">
					<h2 className="text-[13px] font-mono tracking-[0.1em] uppercase text-muted">
						Connected Repos
					</h2>
					<span className="inline-flex items-center px-2 py-0.5 text-[10px] font-mono tracking-wider uppercase rounded-full bg-accent/10 text-accent border border-accent/20">
						Coming Soon
					</span>
				</div>
				<div className="rounded-xl border border-border/50 bg-card-bg/50 p-8 text-center">
					<p className="text-[13px] text-muted/70">
						Connect a GitHub repo to auto-sync skills. This feature is under development.
					</p>
				</div>
			</section>
		</div>
